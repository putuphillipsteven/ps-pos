...
import { CreateTransactionService, TransactionService } from '../service/transactionService';
...
// export const findTransactionController = async (req: Request, res: Response) => {
// 	try {
// 		const { id } = req.params;
...
// export const groupTransactionByDateController = async (req: Request, res: Response) => {
// 	try {
...
export class TransactionController {
	...
	public async createTransaction(req: Request, res: Response, next: NextFunction) {
		const {
			...
			payment_amount,
			customer_name,
		}: CreateTransactionService = req.body;
		try {
